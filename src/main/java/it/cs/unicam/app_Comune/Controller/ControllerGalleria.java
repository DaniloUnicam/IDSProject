...
public class ControllerGalleria {
    ...
    // public List<? extends it.cs.unicam.app_Comune.InformazioneTerritoriale> ottieniInformazione(String idInformazioneTerritoriale,
    //                                                                   String idUtente){
    //}
    ...
    //idInfo
    //public it.cs.unicam.app_Comune.InformazioneTerritoriale[] ottieniInformazioni(String idInformazione){
